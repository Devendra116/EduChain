...
const { getCourses, addModule, addChapter, courseInProgress, getChapterStatusDetail, getModuleStatusDetail, getCourseStatusDetail, courseCompleted, completeCourse, addAssessment, getModuleDetail, getChapterDetail, createCourse, getCourseDetail, coursePaymentApproval } = require('../controllers/course')
const { userAuth } = require('../middleware/userAuth')

router.get('/', getCourses)
router.get('/course-in-progress', userAuth, courseInProgress)
router.get('/course-completed', userAuth, courseCompleted)
router.get('/status/module/:moduleId/chapter', userAuth, getChapterStatusDetail)
